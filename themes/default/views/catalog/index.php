...
//                }
                              ...
                              if($num>0){
                                  foreach($recommendItems as $value){
                                         if($value->getMainPic()){
                                            ...
                                            $picUrl=$imageHelper->thumb('160','160',$value->getMainPic());
                                        }else {
                                            $picUrl=$value->getHolderJs('160','160');
                                        }
                                  ?>
        ...
        <div class="pd_l_fr">
            ...
            <div class="pd_select">
                <?php if ($categories) { ?>
	                <li class="pd_select_title">分类：</li>
                    <ul>
...
//                        ?>
<!--	                    <div class="pd_select_props">-->
<!--                        <div class="pd_select_title">--><?php //echo $itemProp->prop_name; ?><!--：</div>-->
<!--	                    <ul>-->
            ...
            <div class="pd_sort" id="pd-sort" data-sort="<?php echo $sort?>">
                ...
                <div class="pd_search">
                    <form method="get">
                        ...
                        <input  id="price_search" style= "width: 50px; background-color: #48A11E; color: #ffffff;" type="submit" value="确定" data-url="<?php echo json_encode($_GET); ?>"/>
                ...
                <div class="pd_page">
                    <?php if ($pager->pageCount > 1 || true) {
                        if ($pager->currentPage == 0 && false) {
                            echo '<span class="end"><a href="javascript:void(0)" class="page_p"> 上一页</a></a></span>';
//                            <img alt="" src=""/>

                        } else {
                            echo '<span><a href="' . Yii::app()->createUrl('catalog/index', array_merge($_GET, array('page' => $pager->currentPage))) .
	                            '" class="page_p">上一页</a></a></span>';
                        }
                        echo ($pager->currentPage + 1) . '/' . $pager->pageCount;
                        if ($pager->currentPage >= $pager->pageCount - 1 && false) {
                            echo '<span class="end"><a href="javascript:void(0)" class="page_n">下一页</a></a></span>';
//                            <img alt="" src=""/>
                        } else {
                            echo '<span><a href="' . Yii::app()->createUrl('catalog/index',
		                            array_merge($_GET, array('page' => $pager->currentPage + 2))) . '" class="page_n">下一页</a></a></span>';
                        }
                    } ?>
                </div>
            </div>
                ...
                <?php foreach ($items as $item) {
                    ...
                    <div class="product_pd">
                        ...
                        <div class="product_price_1" align="center">
                            <div class="product_price_n1 center-block"><?php echo $item->price. '/'. $item->currency; ?></div>
            ...
            <div class="page_p">
                <?php if ($pager->pageCount > 1 ) {
                    if ($pager->currentPage == 0 ) {
                        echo '<span class="end"><a href="javascript:void(0)" class="page_p">
