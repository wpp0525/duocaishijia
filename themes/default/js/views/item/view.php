...
//                        echo '<li><img src="' .$picUrl . '" width="450" height="450"></li>';
                        echo'<div><a href="javascript:void(0)" target="_blank" rel="nofollow"><img  margin-left = "20px"  position=absolute   alt="' . $item->title . '" src="'  .$picUrl . '" width="450" height="450"/></a></div>';
                    } ?>
                </ul>
            </div>
        </div>
