 ...
 <div class="container" id="demo-table" >
   <table class="table table-striped table-bordered">
       <tr>
           ...
           <td class="col-xs-4"><?php echo $model->id; ?></td>
       </tr>
       <tr>
           <th class="col-xs-2">Username：</th>
           <td class="col-xs-4"><?php echo $model->username;?></td>
       </tr>
       <tr>
       ...
       <tr>
           ...
           <td class="col-xs-4"><?php echo $model->email;?></td>
       </tr>
       <tr>
           <th class="col-xs-2">profile：</th>
           <td class="col-xs-4"><?php echo $model->profile;?></td>
       </tr>
