...
//	const PAY_FULL = 2;
	...
	const PAY_ADVANCE = 1;  // 预付款  这几个状态和 order里的状态一致
	const PAY_FINAL = 2;    // 尾款
	const PAY_FULL = 3;     // 全款
    /**
    ...
    public function rules()
    {
        ...
        return array(
            array('order_id, payment_sn, money', 'required'),
    ...
    public function relations()
    {
        ...
        return array(
       //     'order' => array(self::BELONGS_TO, 'Order', 'order_id'),  //去除外键功能
        );
    }
