...
class OrderLog extends CActiveRecord
{
    ...
    public function search()
    {
        ...
        $criteria->compare('origin_body',$this->origin_body,true);
    ...
    protected function beforeSave(){
        $this->action_time = date('Y-m-d H:i:s', time());
        $this->user_id = Yii::app()->user->id != 0 ? Yii::app()->user->id : '999999';
        parent::beforeSave();
        return true;
    }
