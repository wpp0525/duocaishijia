...
class Shipping extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('ship_id, order_id, ship_sn, type, ship_method, op_name, status, receiver_name, receiver_phone, receiver_mobile, location, create_time, update_time', 'safe', 'on'=>'search'),
        );
    }
