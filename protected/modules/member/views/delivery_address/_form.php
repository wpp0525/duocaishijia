...
<?php
 ...
 ?>
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'contact_name',array('class'=>'col-xs-2 control-label' , 'style'=>"text-align: right")); ?>
        <div class="col-xs-7">
    ...
    <div class="form-group" style="height:40px; overflow:hidden;border:1px solid white">
        <label class="col-xs-2 control-label" style="text-align: right"><b>所在地区：</b><span class="required">*</span></label>
        <?php
        ...
        echo '&nbsp;&nbsp;&nbsp;&nbsp;'.CHtml::dropDownList('AddressResult[state]', $s_default, $state,
                array(
                    ...
                    'ajax' => array(
                        ...
                        'url'=>CController::createUrl('DynamicStoreCities'), //url to call
...
<!--    </div>-->
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model,'address',array('class'=>'col-xs-2 control-label','style'=>"text-align: right")); ?>
        <div class="col-xs-7">
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model,'mobile_phone',array('class'=>'col-xs-2 control-label','style'=>"text-align: right")); ?>
        <div class="col-xs-7">
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model,'phone',array('class'=>'col-xs-2 control-label','style'=>"text-align: right")); ?>
        <div class="col-xs-7">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'is_default',array('class'=>'col-xs-2 control-label','style'=>"text-align: right")); ?>
        <div class="col-xs-7">
    ...
    <div class="form-group">
        <?php echo $form->labelEx($model,'memo',array('class'=>'col-xs-2 control-label','style'=>"text-align: right")); ?>
        <div class="col-xs-7">
