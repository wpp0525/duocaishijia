...
.new-btn-login{
    ...
    background-image: url("/images/alipay/new-btn-fixed.png");
    border: medium none;
}
.new-btn-login{
...
<body text=#000000 bgColor=#ffffff leftMargin=0 topMargin=4>
	<div id="main">
        ...
        <form name=alipayment action="/alipay/default/api" method=post target="_parent">
            <div id="body" style="clear:left">
                <dl class="content">
                    <dt>商户订单号：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDout_trade_no" readonly  value="<?php echo $orderId ?>"/>
                        <span>
</span>
                    </dd>
                    <dt>订单名称：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDsubject" value="<?php echo $WIDsubject?>"/>
                        <span>
</span>
                    </dd>
                    <dt>付款金额：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDtotal_fee" value="<?php echo $amount ?>" />
                        <span>
</span>
                    </dd>
                    <dt>订单描述
